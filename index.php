    ...
    <section class="hero bg-image" data-image-src="images/img/bg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Eat whatever, eat whenever ! </h1>
                <h5 class="font-white space-xs">Find popular dishes and restaurants with us.</h5>
                <div class="banner-form">
                    <form class="form-inline" method="get" action="search.php">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputAmount">find your best food here</label>
                            <div class="form-group">
                                <input type="search" name="search" class="form-control form-control-lg" id="exampleInputAmount" placeholder="find your best food here">
                            </div>
                        </div>
                        <button onclick="location.href='search.php'" type="submit" class="btn theme-btn btn-lg">Search</button>
                    </form>
                </div>
                <div class="steps">
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span>3. </span>Get Delivered</h4>
                    </div>
                    <!-- end:Step -->
                </div>
                <!-- end:Steps -->
        ...
        <div class="container">
            ...
            <center>
                <div class="row content">
                    <div class="col">
                        <p>Welcome to FoodyVille, your ultimate destination for delightful food experiences! We are a passionate team of food enthusiasts dedicated to delivering the best culinary delights to your doorstep. FoodyVille is not just a food delivery app; it's a gateway to a world of flavors, where you can explore diverse cuisines, uncover local gems, and satisfy your cravings with ease. Our mission is to redefine food delivery, ensuring a seamless and enjoyable experience for our valued customers. With FoodyVille, you can relish your favorite dishes from beloved restaurants, quickly and conveniently. We take pride in selecting partner restaurants that share our commitment to quality, taste, and hygiene. Our user-friendly app guarantees a hassle-free ordering process, real-time tracking, and secure payments. At FoodyVille, we value your feedback and smiles, aiming to continuously innovate and excel in the food delivery landscape. </p>
                        <h3>Thank you for choosing FoodyVille, where every dish tells a delicious story. Let's embark on this culinary journey together!</h3>
                    </div>
                </div>
        </div>
        </center>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Treat you self with a good meal..</p>
            </div>
            <div class="row">
                <?php
