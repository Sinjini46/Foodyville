...
<head>
    ...
    <!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="images/foodyville.png">
    <title>foodyville - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon -->
                        <b><img src="images/foodyville.png" alt="homepage" class="dark-logo" width = "25px"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
        ...
        <div class="page-wrapper">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2022 All rights reserved. Made with &#x1F49C; by <b><a href="https://www.youtube.com/channel/UC4_6-VSWBw_QHMyjrDDEvVQ"> GPW</a></b> Team.
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
