                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link scrollto active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link scrollto active" href="restaurants.php">Restaurants <span class="sr-only"></span></a> </li>

							<?php
						if(empty($_SESSION["user_id"]))
							{
								echo '<li class="nav-item"><a href="login.php" class="nav-link scrollto active">Login</a> </li>
							  <li class="nav-item"><a href="registration.php" class="nav-link scrollto active">Sign Up</a> </li>';
							}
						else
							{


										echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link scrollto active">Your Orders</a> </li>';
									echo  '<li class="nav-item"><a href="logout.php" class="nav-link scrollto active">LogOut</a> </li>';
							}
						?>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Choose payment & get Delivered with love.</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
